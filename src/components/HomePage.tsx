    ...
    <div className="min-h-screen flex flex-col bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('/Background.png')` }}>
      ...
      <main className="flex-grow p-8">
        <section className="text-center mb-16">
          <img src="/narrative-nest-logo.png" alt="Narrative Nest" className="mx-auto mb-4" />
          <h1 className="text-6xl font-bold mb-4 text-brown-800">Visualize It as You Narrate It</h1>
